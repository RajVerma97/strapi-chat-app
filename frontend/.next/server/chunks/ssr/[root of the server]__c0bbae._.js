...
function Register() {
    ...
    const [, setSuccess] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    const handleRegister = async (e)=>{
        e.preventDefault();
        setError("");
        setSuccess("");
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contants$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEXT_PUBLIC_BACKEND"]}/api/auth/local/register`, {
                username,
                email,
                password
            });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c0bbae._.js.map