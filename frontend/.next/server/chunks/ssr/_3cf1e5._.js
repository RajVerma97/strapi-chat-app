...
"[project]/src/queries/login-user.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function registerUser(data) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axiosInstance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/user/login", data);
    return response.data;
}
}}),
"[project]/src/hooks/use-login-user-mutation.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$queries$2f$login$2d$user$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/queries/login-user.ts [app-ssr] (ecmascript)");
;
;
function useLoginUserMutation(options) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$authenticated$2d$mutation$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])({
        mutationFn: async (data)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$queries$2f$login$2d$user$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(data),
        onSuccess: (data)=>{
...
function Login() {
    ...
    const [identifier] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const handleLogin = async (e)=>{
        ...
        // setError("");
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/api/auth/local`, {
                identifier,
                password
            });
...
//# sourceMappingURL=_3cf1e5._.js.map