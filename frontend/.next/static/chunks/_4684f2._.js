(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_4684f2._.js", {
...
"[project]/src/queries/login-user.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function registerUser(data) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axiosInstance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/user/login", data);
...
"[project]/src/hooks/use-login-user-mutation.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, k: __turbopack_refresh__, m: module, z: require } = __turbopack_context__;
{
__turbopack_esm__({
    "default": (()=>useLoginUserMutation)
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$queries$2f$login$2d$user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/queries/login-user.ts [app-client] (ecmascript)");
var _s = __turbopack_refresh__.signature();
;
;
function useLoginUserMutation(options) {
    _s();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$authenticated$2d$mutation$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        mutationFn: {
            "useLoginUserMutation.useAuthenticatedMutation": async (data)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$queries$2f$login$2d$user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(data)
        }["useLoginUserMutation.useAuthenticatedMutation"],
        onSuccess: {
            "useLoginUserMutation.useAuthenticatedMutation": (data)=>{
                options?.onSuccess?.(data);
            }
        }["useLoginUserMutation.useAuthenticatedMutation"],
        onError: {
            "useLoginUserMutation.useAuthenticatedMutation": (error)=>{
                options?.onError?.(error);
            }
        }["useLoginUserMutation.useAuthenticatedMutation"]
    });
}
_s(useLoginUserMutation, "ZMUchh7I1k5JQ6XmtpTx5Vnt39s=", false, function() {
    return [
...
function Login() {
    ...
    const [identifier] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const handleLogin = async (e)=>{
        ...
        // setError("");
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/api/auth/local`, {
                identifier,
                password
            });
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen p-6 md:p-0 flex items-center justify-center bg-gradient-to-r from-purple-400 to-indigo-500 text-black",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "bg-white shadow-lg rounded-lg p-12 md:p-8 max-w-md w-full",
            children: [
...
_s(Login, "NtT1q1txeuE8C23xqEKwJ6xaUaQ=");
_c = Login;
var _c;
...
//# sourceMappingURL=_4684f2._.js.map