(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_9b640e._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$login$2d$user$2d$mutation$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/hooks/use-login-user-mutation.tsx [app-client] (ecmascript)");
...
function Login() {
    ...
    const loginMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$login$2d$user$2d$mutation$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        onSuccess: {
            "Login.useLoginUserMutation[loginMutation]": (data)=>{
                ...
                setTimeout({
                    "Login.useLoginUserMutation[loginMutation]": ()=>{
                        window.location.reload();
                    }
                }["Login.useLoginUserMutation[loginMutation]"], 2000);
            }
        }["Login.useLoginUserMutation[loginMutation]"],
        onError: {
            "Login.useLoginUserMutation[loginMutation]": (error)=>{
...
_s(Login, "nJ3hNysU9rQu6RX0ryEybUWEcKw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$login$2d$user$2d$mutation$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
    ];
});
_c = Login;
var _c;
...
//# sourceMappingURL=_9b640e._.js.map